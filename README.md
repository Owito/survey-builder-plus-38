...
Sistema de encuestas web desarrollado como proyecto académico para Desarrollo de Software en Equipo (TSP)
...
- **Autenticación de usuarios**: Registro e inicio de sesión seguro mediante Postgres (Supabase)
